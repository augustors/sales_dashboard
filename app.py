...
def graph3(team, toggle):
    ...
    fig3.add_annotation(text='Chamadas Médias por dia do Mês', xref="paper", yref="paper", font=dict(size=17, color='gray'),
    ...
    fig3.add_annotation(text=f"Média: {round(df_3['Chamadas Realizadas'].mean(), 2)}", 
        xref="paper", yref="paper", font=dict(size=17, color='gray'),
        align="center", bgcolor="rgba(0,0,0,0.8)", x=0.05, y=0.55, showarrow=False)
...
def graph4(team, toggle):
    ...
    fig4.add_annotation(text='Chamadas Médias por dia do Mês', xref="paper", yref="paper", font=dict(size=15, color='gray'),
        align='center', bgcolor="rgba(0,0,0,0.8)", x=0.05, y=0.85, showarrow=False)

    fig4.add_annotation(text=f"Média: {round(df_4['Chamadas Realizadas'].mean(), 2)}", xref="paper", yref="paper", font=dict(size=17, color='gray'),
        align="center", bgcolor="rgba(0,0,0,0.8)", x=0.05, y=0.55, showarrow=False)
...
def graph7(toggle):
    ...
    fig7.update_layout(main_config, yaxis={'title': None}, height=190, template=template)
